...
%>			<tr>
				<td class="item3"><%=gal.getG_id() %></td>
				<td class="item2"><a href="ViewGalleryCtrl?g_id=<%=gal.getG_id() %>"><%=gal.getG_name() %></a></td>
				<td class="item4"><%=gal.getG_content() %></td>
			</tr>
			<tr>
				<td class="item1" colspan="3">
					<a href="ViewGalleryCtrl?g_id=<%=gal.getG_id() %>"><img src="<%=gal.getG_img() %>" alt="<%=gal.getG_img() %>" /></a>
				</td>
			</tr>
