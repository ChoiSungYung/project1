...
<head>
 ...
 <style type="text/css">
     .history{padding-bottom: 10px; list-style:url("./img/heart.png"); }
 </style>
            ...
            <section class="con">
                <aside class="sidebar">
                    <nav class="lnb">
                        <ul>
                            ...
                            <li><a href="companyinfo_history.jsp" class="cur">회사연혁</a></li>              
                ...
                <div class="con_data">
                        <ul class="history_box">
                            <li class="history">2021.12 연매출 1000억 달성</li>   
                            <li class="history">2021.11 연매출 100억 달성</li>
                            <li class="history">2021.10 연매출 10억 달성</li>                              
                            <li class="history">2021.9 연매출 5억 달성</li>                                    
                        </ul>
                </div>    
            </section>    
        </div>
