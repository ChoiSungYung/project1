...
<%
		...
		try {  
			...
			String saveDirectory = "D:\\CSY\\eclipse_jsp\\project1\\WebContent\\img\\gallery";
		...
		if(uploadFile==null) {
			...
			out.println("<a href='javascript:apply(\""+"./img/gallery/"+uploadFile+"\")'>"+uploadFile+" [적용]</a>");
...
%>
		...
		function apply(id){
			...
			opener.document.frm.g_img.value=id;
			opener.document.getElementById("proData").alt = id;
