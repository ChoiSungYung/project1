...
//연결자/상태코드/DB 접속 정보/sql 변수 선언
		...
		try {
			...
			sql = "select substr(g_id,2,4) as g_code from (select * from gallery order by g_id desc) where rownum <=1";
			stmt = con.prepareStatement(sql);
			rs = stmt.executeQuery();
			//String data;
			int data;
			if(rs.next()){
				data = Integer.parseInt(rs.getString("g_code"));
...
%>
<form action="AddGalleryCtrl" method="post" id="frm" name="frm">
	<table class="tb">
		<tbody>
			<tr>
				<th class="col_hd">
				...
				<td class="col_data">
					<input type="text" id="g_id" name="g_id" class="in_data" value="<%=g_code%>" readonly required />
				</td>
			</tr>
			<tr>
				<th class="col_hd">
				...
				<td class="col_data">
					<input type="text" id="g_name" name="g_name" class="in_data" value=""  required />
				</td>
			</tr>
			<tr>
				<th class="col_hd">
			...
			<tr>
				...
				<td class="col_data">
					<input type="text" id="g_content" name="g_content" class="in_data" value=""  required />
				</td>
			</tr>
		</tbody>
	</table>
