...
<style>
    .poster { display:block; opacity:0;  }
</style>
<body>
...
<div class="wrap">
  ...
  <%@ include file = "header.jsp" %>
	...
	<section class="content">
      		...
      		<ul class="img_box">
                    <li>
                        ...
                        <div class="tit_box">
                            ...
                            <a href="ViewProductCtrl?pronum=A0007" class="more">더보기</a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="tit_box">
                            ...
                            <a href="ViewProductCtrl?pronum=A0016" class="more">더보기</a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="tit_box">
                            ...
                            <a href="ViewProductCtrl?pronum=A0006" class="more">더보기</a>
                        </div>
                    </li>
                </ul>        
        </figure>
        <div class="idx_con notice">
           <h2 class="idx_tit">공지사항</h2><a class="lst_more" href="NoticeListCtrl">더보기</a>
	        <ul class="noti_lst">
	        	<li class="noti_header">
	        		<h3 class="noti_tit">제목</h3>
	        		<p class="noti_con">내용</p>
	        		<p class="noti_date">게시날짜</p>
	        	</li>
	        <% 
			Connection con = null;
			Statement stmt = null;
			...
			sql = "select * from (select * from notice order by n_id desc) where rownum<=3";
	        ...
	        %>
				...
				if(sid!=null){
				%>
				<h3 class="noti_tit"><a href="ViewNoticeCtrl?id=<%=n_id %>"><%= title%></a></h3>
				<%
				} else {
				%>
	        	<h3 class="noti_tit"><%= title%></h3>
				<% 
				}
				%>
	        		<p class="noti_con"><%= content%></p>
	        		<p class="noti_date"><%= resdate%></p>
	        	</li>
	        <% 
	        }
            rs.close();
        ...
        <div class="idx_con product">
        	<h2 class="idx_tit">현재 상영중인 영화</h2><a class="lst_more" href="ProductListCtrl">더보기</a>
            <ul>
            <%		
    		sql = "select * from (select * from m_product order by proNum asc) where rownum <= 12 ";
    		rs = stmt.executeQuery(sql);

			while(rs.next()) {
			String pro_num = rs.getString("proNum");
			...
			%>      
               <li>            
                    <a class="poster" href="ViewProductCtrl?pronum=<%=pro_num %>"><img src="<%=pro_img%>" alt="<%=pro_name%>"></a>
                    <h3 class="pro_tit"><a href="ViewProductCtrl?pronum=<%=pro_num%>"><%=pro_name%></a></h3>
                    <!--
       ...
       <script>
            $(document).ready(function(){
                $(".poster").delay(100).animate({"opacity":"1"}, 2000);
            });    
        </script>
    </section>
  <!-- 푸터 -->
